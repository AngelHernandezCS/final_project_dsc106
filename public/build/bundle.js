...
var app = (function () {
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t10 = space();
    			br5 = element("br");
    			add_location(b, file$8, 10, 28, 507);
    			attr_dev(p0, "class", "body-text svelte-1tdzw38");
    			add_location(p0, file$8, 4, 2, 32);
    			add_location(br0, file$8, 12, 2, 532);
    			attr_dev(p1, "class", "body-text svelte-1tdzw38");
    			add_location(p1, file$8, 13, 2, 539);
    			add_location(br1, file$8, 20, 2, 958);
    			add_location(br2, file$8, 21, 2, 965);
    			add_location(br3, file$8, 22, 2, 972);
    			add_location(br4, file$8, 23, 2, 979);
    			add_location(br5, file$8, 24, 2, 986);
    			add_location(section, file$8, 3, 0, 20);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$7 = "src/Components/Scrolly.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$7, 80, 2, 2142);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$6 = "src/Components/Points.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$6, 99, 2, 3014);
    			attr_dev(svg_1, "id", "map");
    			attr_dev(svg_1, "class", "svelte-z5x917");
    			add_location(svg_1, file$6, 101, 4, 3088);
    			attr_dev(div0, "id", "map-container");
    			attr_dev(div0, "class", "svelte-z5x917");
    			add_location(div0, file$6, 100, 2, 3059);
    			attr_dev(div1, "class", "container");
    			add_location(div1, file$6, 98, 0, 2988);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*airbasesGroup, value, airportGroup*/ 7) {
    	...
    	return [value, airbasesGroup, airportGroup];
    }

    class Points extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$6, create_fragment$6, safe_not_equal, { value: 0 });
    ...
    const file$5 = "src/Components/ScrollCenter.svelte";
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$5, 37, 14, 1309);
    			attr_dev(div1, "class", "step svelte-qs9v12");
    			toggle_class(div1, "active", /*value*/ ctx[0] === /*i*/ ctx[5]);
    			add_location(div1, file$5, 36, 12, 1249);
    			add_location(div2, file$5, 35, 10, 1231);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(35:8) {#each steps as text, i}",
    		ctx
    	});
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$5, 41, 8, 1414);
    		},
    		m: function mount(target, anchor) {
    			for (let i = 0; i < each_blocks.length; i += 1) {
    				if (each_blocks[i]) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(34:6) <Scrolly bind:value>",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$5, 27, 4, 1032);
    			attr_dev(div1, "class", "steps-container svelte-qs9v12");
    			add_location(div1, file$5, 32, 4, 1131);
    			attr_dev(section, "class", "container svelte-qs9v12");
    			add_location(section, file$5, 25, 2, 967);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$4 = "src/Components/Conclusion.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 1, 2, 28);
    			attr_dev(p, "class", "body-text");
    			add_location(p, file$4, 2, 2, 75);
    ...
    const file$3 = "src/Components/Resources.svelte";
    ...
    const file$2 = "src/Components/ScrollSide.svelte";
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 130, 8, 4631);
    		},
    		m: function mount(target, anchor) {
    			for (let i = 0; i < each_blocks.length; i += 1) {
    				if (each_blocks[i]) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$2, 115, 0, 4121);
    			attr_dev(p0, "class", "body-text");
    			add_location(p0, file$2, 116, 0, 4175);
    			attr_dev(div0, "class", "steps-container svelte-xapixo");
    			add_location(div0, file$2, 123, 4, 4380);
    			attr_dev(svg0, "id", "chart1");
    			attr_dev(svg0, "class", "svelte-xapixo");
    			add_location(svg0, file$2, 135, 8, 4760);
    			attr_dev(div1, "class", "chart-one svelte-xapixo");
    			add_location(div1, file$2, 134, 6, 4727);
    			attr_dev(svg1, "id", "chart2");
    			attr_dev(svg1, "class", "svelte-xapixo");
    			add_location(svg1, file$2, 138, 8, 4834);
    			attr_dev(div2, "class", "chart-two svelte-xapixo");
    			add_location(div2, file$2, 137, 6, 4801);
    			attr_dev(div3, "class", "charts-container svelte-xapixo");
    			add_location(div3, file$2, 133, 4, 4689);
    			attr_dev(div4, "class", "section-container svelte-xapixo");
    			add_location(div4, file$2, 122, 2, 4343);
    			add_location(br0, file$2, 142, 2, 4893);
    			add_location(br1, file$2, 142, 8, 4899);
    			attr_dev(p1, "class", "body-text");
    			add_location(p1, file$2, 143, 2, 4909);
    			add_location(section, file$2, 120, 0, 4301);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
  ...
  `
    ...
    const file$1 = "src/Components/Choropleth.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h1 = element("h1");
    			h1.textContent = "Amount Of UFO Sightings by State";
    			t1 = space();
    			svg = svg_element("svg");
    			attr_dev(h1, "id", "title");
    			attr_dev(h1, "class", "svelte-9grdif");
    			add_location(h1, file$1, 69, 2, 2274);
    			attr_dev(svg, "id", "choropleth");
    			attr_dev(svg, "class", "svelte-9grdif");
    			add_location(svg, file$1, 71, 2, 2332);
    			attr_dev(div, "class", "container");
    			add_location(div, file$1, 68, 0, 2248);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(scrollcenter, div3, null);
    			insert_dev(target, t3, anchor);
    			insert_dev(target, div4, anchor);
    			mount_component(choropleth, div4, null);
