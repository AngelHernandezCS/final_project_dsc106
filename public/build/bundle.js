...
var app = (function () {
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h10 = element("h1");
    			h10.textContent = "Beginners Guide To UFO Spotting";
    			t1 = space();
    			h11 = element("h1");
    			h11.textContent = "They're out there!";
    			t3 = space();
    			h3 = element("h3");
    			a = element("a");
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t10 = space();
    			br5 = element("br");
    			add_location(b, file$9, 10, 28, 507);
    			attr_dev(p0, "class", "body-text svelte-1tdzw38");
    			add_location(p0, file$9, 4, 2, 32);
    			add_location(br0, file$9, 12, 2, 532);
    			attr_dev(p1, "class", "body-text svelte-1tdzw38");
    			add_location(p1, file$9, 13, 2, 539);
    			add_location(br1, file$9, 20, 2, 975);
    			add_location(br2, file$9, 21, 2, 982);
    			add_location(br3, file$9, 22, 2, 989);
    			add_location(br4, file$9, 23, 2, 996);
    			add_location(br5, file$9, 24, 2, 1003);
    ...
    const file$8 = "src/Components/Scrolly.svelte";
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$8, 80, 2, 2142);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function bisector$1(f) {
      ...
      if (f.length !== 2) {
        ...
        compare1 = f === ascending$7 || f === descending$2 ? f : zero$1;
        compare2 = f;
        delta = f;
      }
    ...
    function compareDefined(compare = ascending$7) {
      if (compare === ascending$7) return ascendingDefined;
    ...
    function groupSort(values, reduce, key) {
      return (reduce.length !== 2
        ? sort(rollup(values, reduce, key), (([ak, av], [bk, bv]) => ascending$7(av, bv) || ascending$7(ak, bk)))
        : sort(group(values, key), (([ak, av], [bk, bv]) => reduce(av, bv) || ascending$7(ak, bk))))
        .map(([key]) => key);
    }
    ...
    function greatest(values, compare = ascending$7) {
      let max;
      let defined = false;
      if (compare.length === 1) {
        let maxValue;
    ...
    function rank(values, valueof = ascending$7) {
      if (typeof values[Symbol.iterator] !== "function") throw new TypeError("values is not iterable");
      ...
      values.sort(valueof === ascending$7 ? (i, j) => ascendingDefined(V[i], V[j]) : compareDefined(compareIndex));
      values.forEach((j, i) => {
    ...
    function least(values, compare = ascending$7) {
      let min;
      let defined = false;
      if (compare.length === 1) {
        let minValue;
    ...
    function leastIndex(values, compare = ascending$7) {
    ...
    function greatestIndex(values, compare = ascending$7) {
    ...
    function ticker$1(year, month, week, day, hour, minute) {
      ...
      function tickInterval(start, stop, count) {
        ...
        if (i === 0) return millisecond$2.every(Math.max(tickStep(start, stop, count), 1));
    ...
    function time() {
      return initRange.apply(calendar(timeTicks$1, timeTickInterval$1, timeYear$1, timeMonth$1, sunday, timeDay$1, timeHour$1, timeMinute$1, utcSecond, timeFormat).domain([new Date(2000, 0, 1), new Date(2000, 0, 2)]), arguments);
    }

    function utcTime() {
      return initRange.apply(calendar(utcTicks$1, utcTickInterval$1, utcYear$2, utcMonth$2, utcSunday$1, utcDay$2, utcHour$2, utcMinute$2, utcSecond, utcFormat).domain([Date.UTC(2000, 0, 1), Date.UTC(2000, 0, 2)]), arguments);
    }
    ...
    /* src/Components/Points.svelte generated by Svelte v3.59.2 */
    const file$7 = "src/Components/Points.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-z5x917");
    			add_location(h1, file$7, 121, 2, 3778);
    			attr_dev(svg_1, "id", "map");
    			attr_dev(svg_1, "class", "svelte-z5x917");
    			add_location(svg_1, file$7, 123, 4, 3852);
    			attr_dev(div0, "id", "map-container");
    			attr_dev(div0, "class", "svelte-z5x917");
    			add_location(div0, file$7, 122, 2, 3823);
    			attr_dev(div1, "class", "container");
    			add_location(div1, file$7, 120, 0, 3752);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		svg = select("#map").attr("width", width).attr("height", height);
    		const geoData = await json('./data/states.json');
    		...
    		data = await csv('./data/locations.csv');

    		// Load the airbases data
    		airbasesData = await csv('./data/airbases.csv');

    		airportData = await csv('./data/airports.csv');

    		// Add the locations
    		const locationsGroup = svg.append("g");

    		locationsGroup.selectAll("circle").data(data).enter().append("circle").attr("cx", d => projection([+d.longitude, +d.latitude])[0]).attr("cy", d => projection([+d.longitude, +d.latitude])[1]).attr("r", 0.5).attr("fill", "yellow").attr("opacity", 1);

    		// Add the airbases with initial opacity 0
    		$$invalidate(1, airbasesGroup = svg.append("g"));

    		airbasesGroup.selectAll("circle").data(airbasesData).enter().append("circle").attr("cx", d => projection([+d.longitude, +d.latitude])[0]).attr("cy", d => projection([+d.longitude, +d.latitude])[1]).attr("r", 3).attr("fill", "red").style("transition", "opacity 1s ease").attr("opacity", 0); // CSS transition for opacity change
    		// Start with opacity 0

    		$$invalidate(2, airportGroup = svg.append('g'));

    		airportGroup.selectAll("circle").data(airportData).enter().append("circle").attr("cx", d => projection([+d.longitude, +d.latitude])[0]).attr("cy", d => projection([+d.longitude, +d.latitude])[1]).attr("r", 4).attr("fill", "#66FF00").style("transition", "opacity 1s ease").attr("opacity", 0); // CSS transition for opacity change
    		// Start with opacity 0

    		const circle = circle$1().center([-85, 37.5]).radius(5);
    		circlePath = path(circle());

    		$$invalidate(3, circleElement = svg.append("path").attr("d", circlePath).attr("stroke", "blue").attr("stroke-width", 2).attr("fill", "none").style("transition", "opacity 1s ease").attr("opacity", 0)); // CSS transition for opacity change
    		// Start with opacity 0
    	});

    	$$self.$$.on_mount.push(function () {
    		if (value === undefined && !('value' in $$props || $$self.$$.bound[$$self.$$.props['value']])) {
    			console.warn("<Points> was created without expected prop 'value'");
    		}
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('airbasesGroup' in $$props) $$invalidate(1, airbasesGroup = $$props.airbasesGroup);
    		if ('data' in $$props) data = $$props.data;
    		if ('airbasesData' in $$props) airbasesData = $$props.airbasesData;
    		if ('airportData' in $$props) airportData = $$props.airportData;
    		if ('airportGroup' in $$props) $$invalidate(2, airportGroup = $$props.airportGroup);
    		if ('circlePath' in $$props) circlePath = $$props.circlePath;
    		if ('circleElement' in $$props) $$invalidate(3, circleElement = $$props.circleElement);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*airbasesGroup, value, airportGroup, circleElement*/ 15) {
    			// Reactive statement to update airbase styles based on value
    			if (airbasesGroup) {
    				if (value === 1) {
    					airbasesGroup.selectAll('circle').attr('opacity', 1);
    					airportGroup.selectAll('circle').attr('opacity', 0);
    					document.getElementById('title').innerText = "Sightings and Military Bases";
    					circleElement.attr('opacity', 0);
    				} else if (value === 0) {
    					airbasesGroup.selectAll("circle").attr("opacity", 0);
    					airportGroup.selectAll('circle').attr('opacity', 0);
    					document.getElementById('title').innerText = "Locations of Sightings";
    					circleElement.attr('opacity', 0);
    				} else if (value == 2) {
    					airportGroup.selectAll("circle").attr('opacity', 1);
    	...
    	return [value, airbasesGroup, airportGroup, circleElement];
    }

    class Points extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$7, create_fragment$7, safe_not_equal, { value: 0 });
    ...
    const file$6 = "src/Components/ScrollCenter.svelte";
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			div0 = element("div");
    			attr_dev(div0, "class", "step-content svelte-qs9v12");
    			add_location(div0, file$6, 41, 14, 1576);
    			attr_dev(div1, "class", "step svelte-qs9v12");
    			toggle_class(div1, "active", /*value*/ ctx[0] === /*i*/ ctx[5]);
    			add_location(div1, file$6, 40, 12, 1516);
    			add_location(div2, file$6, 39, 10, 1498);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*steps*/ 2 && raw_value !== (raw_value = /*text*/ ctx[3] + "")) div0.innerHTML = raw_value;
    			if (dirty & /*value*/ 1) {
    				toggle_class(div1, "active", /*value*/ ctx[0] === /*i*/ ctx[5]);
    			}
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(39:8) {#each steps as text, i}",
    		ctx
    	});
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			div = element("div");
    			attr_dev(div, "class", "spacer svelte-qs9v12");
    			add_location(div, file$6, 45, 8, 1681);
    		},
    		m: function mount(target, anchor) {
    			for (let i = 0; i < each_blocks.length; i += 1) {
    				if (each_blocks[i]) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(38:6) <Scrolly bind:value>",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "map-container svelte-qs9v12");
    			add_location(div0, file$6, 31, 4, 1299);
    			attr_dev(div1, "class", "steps-container svelte-qs9v12");
    			add_location(div1, file$6, 36, 4, 1398);
    			attr_dev(section, "class", "container svelte-qs9v12");
    			add_location(section, file$6, 29, 2, 1234);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(points, div0, null);
    		...
    		p: function update(ctx, [dirty]) {
    			const points_changes = {};
    			if (dirty & /*value*/ 1) points_changes.value = /*value*/ ctx[0];
    			points.$set(points_changes);
    			const scrolly_changes = {};

    			if (dirty & /*$$scope, steps, value*/ 67) {
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Scrolly, Points, value, steps });
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$5, 1, 2, 28);
    			attr_dev(p, "class", "body-text");
    			add_location(p, file$5, 2, 2, 75);
    ...
    const file$3 = "src/Components/ScrollSide.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*steps*/ 2 && raw_value !== (raw_value = /*text*/ ctx[5] + "")) div0.innerHTML = raw_value;
    			if (dirty & /*value*/ 1) {
    				toggle_class(div1, "active", /*value*/ ctx[0] === /*i*/ ctx[7]);
    			}
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(126:8) {#each steps as text, i}",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 130, 8, 4631);
    		},
    		m: function mount(target, anchor) {
    			for (let i = 0; i < each_blocks.length; i += 1) {
    				if (each_blocks[i]) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(125:6) <Scrolly bind:value>",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h2 = element("h2");
    			h2.textContent = "What Should I Look For?";
    			t1 = space();
    			p0 = element("p");
    			p0.textContent = "From previous sightings we've composed the top 4 descriptions people have\r\n  given for a UFO.";
    			t3 = space();
    			section = element("section");
    			div4 = element("div");
    			div0 = element("div");
    			...
    			add_location(h2, file$3, 115, 0, 4121);
    			attr_dev(p0, "class", "body-text");
    			add_location(p0, file$3, 116, 0, 4175);
    			attr_dev(div0, "class", "steps-container svelte-xapixo");
    			add_location(div0, file$3, 123, 4, 4380);
    			attr_dev(svg0, "id", "chart1");
    			attr_dev(svg0, "class", "svelte-xapixo");
    			add_location(svg0, file$3, 135, 8, 4760);
    			attr_dev(div1, "class", "chart-one svelte-xapixo");
    			add_location(div1, file$3, 134, 6, 4727);
    			attr_dev(svg1, "id", "chart2");
    			attr_dev(svg1, "class", "svelte-xapixo");
    			add_location(svg1, file$3, 138, 8, 4834);
    			attr_dev(div2, "class", "chart-two svelte-xapixo");
    			add_location(div2, file$3, 137, 6, 4801);
    			attr_dev(div3, "class", "charts-container svelte-xapixo");
    			add_location(div3, file$3, 133, 4, 4689);
    			attr_dev(div4, "class", "section-container svelte-xapixo");
    			add_location(div4, file$3, 122, 2, 4343);
    			add_location(br0, file$3, 142, 2, 4893);
    			add_location(br1, file$3, 142, 8, 4899);
    			attr_dev(p1, "class", "body-text");
    			add_location(p1, file$3, 143, 2, 4909);
    			add_location(section, file$3, 120, 0, 4301);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const resetCharts = () => {
    		select$1("#chart1").selectAll("*").remove();
    		select$1("#chart2").selectAll("*").remove();
    	};

    	const target2event = {
    		0: () => {
    			select$1("#chart1").style("background-color", "red");
    			select$1("#chart1").selectAll("*").remove();
    			select$1("#chart1").append("text").attr("x", "50%").attr("y", "50%").attr("dominant-baseline", "middle").attr("text-anchor", "middle").text("Light: 16565").style("fill", "white").style("font-size", "24px");
    			select$1("#chart2").style("background-color", "green");
    			select$1("#chart2").selectAll("*").remove();
    			select$1("#chart2").append("text").attr("x", "50%").attr("y", "50%").attr("dominant-baseline", "middle").attr("text-anchor", "middle").text("Triangle: 7865").style("fill", "white").style("font-size", "24px");
    		},
    		1: () => {
    			select$1("#chart1").style("background-color", "purple");
    			select$1("#chart1").selectAll("*").remove();
    			select$1("#chart1").append("text").attr("x", "50%").attr("y", "50%").attr("dominant-baseline", "middle").attr("text-anchor", "middle").text("Circle: 7608").style("fill", "white").style("font-size", "24px");
    			select$1("#chart2").style("background-color", "coral");
    			select$1("#chart2").selectAll("*").remove();
    			select$1("#chart2").append("text").attr("x", "50%").attr("y", "50%").attr("dominant-baseline", "middle").attr("text-anchor", "middle").text("Fireball: 6208").style("fill", "white").style("font-size", "24px");
    		},
    		2: () => {
    			select$1("#chart1").style("background-color", "purple");
    			select$1("#chart1").selectAll("*").remove();
  ...
  `
    ...
    /* src/Components/Choropleth.svelte generated by Svelte v3.59.2 */
    const file$2 = "src/Components/Choropleth.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h1 = element("h1");
    			h1.textContent = "Number   of UFO Sightings by State";
    			t1 = space();
    			svg0 = svg_element("svg");
    			t2 = space();
    			svg1 = svg_element("svg");
    			attr_dev(h1, "id", "chloro");
    			attr_dev(h1, "class", "svelte-rnemil");
    			add_location(h1, file$2, 115, 2, 3477);
    			attr_dev(svg0, "id", "choropleth");
    			attr_dev(svg0, "class", "svelte-rnemil");
    			add_location(svg0, file$2, 117, 2, 3538);
    			attr_dev(svg1, "id", "legend");
    			attr_dev(svg1, "class", "svelte-rnemil");
    			add_location(svg1, file$2, 118, 2, 3568);
    			attr_dev(div, "class", "container");
    			add_location(div, file$2, 114, 0, 3451);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Choropleth', slots, []);
    	let width = 800;
    	let height = 600;

    	onMount(async () => {
    		const svg = select("#choropleth").attr("width", width).attr("height", height);

    		// Load data and the GeoJSON file
    		const data = await csv('./data/filtered_scrubbed.csv');
    		...
    		const colorScale = sequential().domain([min$3(data, d => +d.count), max$5(data, d => +d.count)]).interpolator(Purples).range([Purples(0.3), Purples(0.9)]); // Using d3.interpolatePurples

    		// Create a projection and path generator
    		const projection = albersUsa().fitSize([width, height], geoData);

    		const path = index$2().projection(projection);
    		const tooltip = select("body").append("div").attr("class", "tooltip").style("position", "absolute").style("background", "#fff").style("padding", "5px").style("border", "1px solid #ccc").style("border-radius", "3px").style("pointer-events", "none").style("display", "none");
    		...
    		const legend = select("#legend").attr("width", 100).attr("height", 200);
    		const legendScale = linear().domain([min$3(data, d => +d.count), max$5(data, d => +d.count)]).range([0, 200]);
    		const legendGradient = legend.append("defs").append("linearGradient").attr("id", "legendGradient").attr("x1", "0%").attr("x2", "0%").attr("y1", "0%").attr("y2", "100%");
    		legendGradient.append("stop").attr("offset", "0%").attr("stop-color", Purples(0.3));
    		legendGradient.append("stop").attr("offset", "100%").attr("stop-color", Purples(0.9));
    		legend.append("rect").attr("x", 10).attr("y", 10).attr("width", 20).attr("height", 200).attr("fill", "url(#legendGradient)");
    		const legendAxis = axisRight(legendScale).tickSize(6).ticks(6).tickPadding(5); // Add some padding between ticks and text
    		legend.append("g").attr("transform", "translate(30, 10)").call(legendAxis).style("fill", "white").selectAll("text").style("fill", "white"); // Select all tick text elements
    	});

    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Choropleth> was created with unknown prop '${key}'`);
    	});

    	$$self.$capture_state = () => ({ d3, onMount, width, height });
    ...
    class Choropleth extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src/Components/Chorotext.svelte generated by Svelte v3.59.2 */

    const file$1 = "src/Components/Chorotext.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			section = element("section");
    			p0 = element("p");
    			t0 = text$1("Aliens must love Hollywood... from the map we can see that\n     California has the most amount of sightings in, 8912 of them, \n     in the United States. A common trend shown is that states located\n     near borders/oceans have many more sightings compared to central \n     states. Maybe the aliens care more for the US neighbors and the beach.\n     But don't pack your bags just yet! Of the top three states:\n     California, Texas, Florida, they have one thing in common,\n     ");
    			b = element("b");
    			b.textContent = "They are Huge!";
    			t2 = text$1(" atleast compared to the rest of the US.\n     Lets take a closer look at the exact locations of these sightings\n     and find dense areas.");
    			t3 = space();
    			br0 = element("br");
    			t4 = space();
    			p1 = element("p");
    			...
    			t9 = space();
    			br5 = element("br");
    			add_location(b, file$1, 12, 5, 538);
    			attr_dev(p0, "class", "body-text svelte-1tdzw38");
    			add_location(p0, file$1, 4, 2, 32);
    			add_location(br0, file$1, 16, 2, 707);
    			attr_dev(p1, "class", "body-text svelte-1tdzw38");
    			add_location(p1, file$1, 17, 2, 714);
    			add_location(br1, file$1, 20, 2, 750);
    			add_location(br2, file$1, 21, 2, 757);
    			add_location(br3, file$1, 22, 2, 764);
    			add_location(br4, file$1, 23, 2, 771);
    			add_location(br5, file$1, 24, 2, 778);
    ...
    function instance$1($$self, $$props) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Chorotext', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Chorotext> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class Chorotext extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment(ctx) {
    	...
    	chorotext = new Chorotext({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			div4 = element("div");
    			create_component(chorotext.$$.fragment);
    			t4 = space();
    			div5 = element("div");
    			...
    			attr_dev(div0, "class", "center svelte-rboab6");
    			add_location(div0, file, 12, 0, 508);
    			attr_dev(div1, "class", "center svelte-rboab6");
    			add_location(div1, file, 17, 0, 550);
    			attr_dev(div2, "class", "center svelte-rboab6");
    			add_location(div2, file, 21, 0, 593);
    			attr_dev(div3, "class", "center svelte-rboab6");
    			add_location(div3, file, 24, 0, 635);
    			attr_dev(div4, "class", "center svelte-rboab6");
    			add_location(div4, file, 28, 0, 680);
    			attr_dev(div5, "class", "center svelte-rboab6");
    			add_location(div5, file, 31, 0, 725);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(chorotext, div4, null);
    			insert_dev(target, t4, anchor);
    			insert_dev(target, div5, anchor);
    			mount_component(scrollcenter, div5, null);
    		...
    		i: function intro$1(local) {
    			...
    			transition_in(chorotext.$$.fragment, local);
    		...
    		o: function outro(local) {
    			...
    			transition_out(chorotext.$$.fragment, local);
    		...
    		d: function destroy(detaching) {
    			...
    			destroy_component(chorotext);
    			if (detaching) detach_dev(t4);
    			if (detaching) detach_dev(div5);
    			destroy_component(scrollcenter);
